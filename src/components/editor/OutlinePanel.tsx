...
return (
  <div style={{
    position: "relative",
    width: visible ? "240px" : "20px",
    minWidth: visible ? "240px" : "20px",
    flexShrink: 0,
    ...
    {visible && (
      <div style={{
        ...
        left: 0,
        right: 0,
        bottom: 0,             // ← now has a real height
        ...
        <div style={{
          ...
          <div style={{ display: "flex", gap: "4px" }}>
            <button
              ...
              {pinned ? <PinOff style={{ width: "12px", height: "12px" }} /> : <Pin style={{ width: "12px", height: "12px" }} />}
            </button>
            <button
              onClick={onToggle}
        ...
        {/* Scrollable list — now has real height from absolute parent */}
        <div style={{
          flex: 1,
          overflowY: "auto",
          overflowX: "hidden",
